...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'aerialphoto_mosaic_tool_dialog_base.ui'))


class AerialPhotoMosaicDialog(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(AerialPhotoMosaicDialog, self).__init__(parent)
